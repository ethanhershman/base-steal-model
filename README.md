...
# 1. Parse steal attempts from the bundled Retrosheet data (2021-2024;
...
- Every steal attempt's runner is resolved (0 unresolved in 2022-2024; 4 of
  2,972 in 2021 — the same documented, benign edge case).
- League steal-success rate ≈ 75-76% in 2021-2022, ≈ 80% in 2023-2024 — the
  data shows the real 2023 pickoff-limit/bigger-base rule change.
